      ...
      <div className="w-[200px] h-[100px] flex flex-col relative items-center justify-end overflow-x-hidden">
        ...
        <div
          className="w-full h-[1.5px] bg-[#282828] relative bottom-0 self-end rounded-[3px]
                     before:content-[''] before:absolute before:w-[20px] before:h-full before:bg-[#282828] before:right-[-50%] before:rounded-[3px] before:animate-road before:border-l-[10px] before:border-white
                     after:content-[''] after:absolute after:w-[10px] after:h-full after:bg-[#282828] after:right-[-65%] after:rounded-[3px] after:animate-road after:border-l-[4px] after:border-white"
        ></div>
